...
if (firstName.length > 0) {
  alert(
    "Welcome, " +
      firstName +
      ". to our innovative To-Do List App, where productivity meets simplicity."
  );
} else {
...
function CreateToDoItems() {
  if (todoValue.value === "") {
    todoAlert.innerText = "Please enter your TO-DO item...";
    todoValue.focus();
  } else {
    let IsPresent = false;
  ...
  todoValue.value = "";
  setAlertMessage("TO-DO item is created successfully!");
}
